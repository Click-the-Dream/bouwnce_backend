...
class NewsLetterUpdate(BaseModel):
    ...
    description: Annotated[str | None, Field(None, description="Description of the newsletter")]
...
class NewsLetterResponseSchema(NewsLetterBase):
    ...
    is_sent: Annotated[bool, Field(..., description="Whether the newsletter has been sent")]
    send_at: Annotated[ str | None, Field(..., description="Scheduled time to send the newsletter")] = None
    status: Annotated[str, Field(..., description="Status of the newsletter")]
    created_at: Annotated[str, Field(..., description="Creation time of the newsletter")]
    updated_at: Annotated[str, Field(..., description="Last update time of the newsletter")]
    
    
class NewsLetterResponse(BaseResponse):
    data: Annotated[NewsLetterResponseSchema, Field(..., description="Newsletter response data")]
    
class PaginatedNewsLetterResponseSchema(BaseModel):
    newsletters: Annotated[list[NewsLetterResponseSchema], Field(..., description="List of newsletter response")]
...
class PaginatedNewsLetterResponse(BaseResponse):
    data: Annotated[PaginatedNewsLetterResponseSchema, Field(..., description="Paginated newsletter response data")]