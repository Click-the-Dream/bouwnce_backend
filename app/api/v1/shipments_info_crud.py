...
async def create_shipment_info(shipment_data: ShipmentsInfoCreate, session=Depends(get_async_session)):
...
async def get_shipment_info(user_id: str, session=Depends(get_async_session)):
...
async def update_shipment_info(shipment_data: ShipmentsInfoUpdate, session=Depends(get_async_session)):
...
async def delete_shipment_info(user_id: str, session=Depends(get_async_session)):
