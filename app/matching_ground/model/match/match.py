...
class Match(BaseModel):
    ...
    target_user: Mapped["User"] = relationship(
        foreign_keys=[target_user_id], lazy="joined"
    )

    @classmethod
    async def find_pair(
        cls, session: AsyncSession, user_a: uuid.UUID, user_b: uuid.UUID
    ) -> Self | None:
    ...
    async def create_accepted(
        ...
        existing = await Match.find_active_between_any_direction(
