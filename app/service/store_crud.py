...
class StoreCRUDService:
    ...
    async def get_full_details(self, current_store: Store) -> dict[str, Any]:
        ...
        if current_store.contact_info:
            store_full_response["contact_info"] = current_store.contact_info.to_dict()
        ...
        if current_store.shipment_info:
            store_full_response["shipment_info"] = [
                shipment_info.to_dict() for shipment_info in current_store.shipment_info
            ]
    ...
    async def delete_brand_images(
        ...
        if public_ids:
            ...
            if is_deleted:
                ...
                raise BadRequestException(message="Unable to delete store brand images")
