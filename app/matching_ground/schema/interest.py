...
class UserInterestCreate(BaseModel):
    interests: Annotated[list[str], Field(description="List of interest ids to add for user")]
...
class UserInterestReponse(BaseResponse):
    data: Annotated[list[UserInterestResponseSchema], Field(description="List of available interest")]